# Ecommerce Portal for IdeasCrafter

<p align="center">
  <a href="https://github.com/IdeasCrafter/ecom-portal-fe"><img height="300" src="public/assets/images/nextjs-starter-banner.png?raw=true" alt="Next js starter banner"></a>
</p>

🚀 Ecommerce-portal

Clone this project and use it to create your system directory.
...
```shell
git clone --depth=1 https://github.com/IdeasCrafter/ecom-portal-fe.git
cd ecom-portal-fe
npm install
```
